...
class NodeUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color iconColor = customIconColor ?? (isDark ? Colors.white : Colors.black);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(docIcon, color: isDark ? Colors.black : Colors.white, size: 14),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      markerStr,
                      style: TextStyle(color: isDark ? Colors.black : Colors.white, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 0.8),
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
                  if (node.isLocked)
                    Padding(
                      ...
                      child: Icon(Icons.lock_rounded, color: isDark ? Colors.black : Colors.white, size: 12),
                    ),
